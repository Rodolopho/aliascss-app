...
Each of these selector function accepts valid aliasCSS selector not, general css selector, this is done to make 
coding less confusion and maintain the same rule across every feature of the design or style system.
...
/* Note the difference between --Is and --is */
```
