        ...
        <div className='df pr g8px w100p fdc '  >
            ...
            <div className="df pr aic w100fr  g16px p8px-12px bgc-gray100 --is(_html.dark)&-bgc-gray900 --is(_html.dark)&-b-1px-s-gray50 br8px g8px b1px-s-gray300   ">
                <div className="df  aic w100p g12px text-lg oya">
                    ...
                    <input  onChange={handleChange} className="oln  bn --fv-bxsn c-gray --is(_html.dark)&-c-gray-25 bgc-transparent text-md w100p "  placeholder="Static classname" />
                </div>
            </div>
           ...
           { !! Object.keys(classNames).length &&  ( 
             <div 
            className=" zi12345 b1px-s-gray300 w100p p8px-12px l0px t100p bgc-gray200 --is(_html.dark)&-bgc-gray-900 xh60vh  mw320px oya shadow-md mt2px br8px">
                ...
                {Object.keys(classNames).map((key,i)=>(
                    <li className="df aic jcsb p8px-12px  w100p" key={i}>
                        <div className="df  fdc w100p  ">
                            <div className="c-gray700 --is(_html.dark)&-c-gray-50 fwb text-sm" >{'.'+key}</div>
                            <div className="c-blue700 --is(_html.dark)&-c-gray-50-i text-sm fw5 asfe ">{ '{ '+classNames[key]+ ' }'}</div>
                        </div>
                    </li>
                ))}
